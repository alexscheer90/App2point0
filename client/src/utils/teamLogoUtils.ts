...
const NON_MAC_SCHOOLS: Record<string, NonMacSchool> = {
  "Mid-American Conference": {
    ...
    logoUrl: "/attached_assets/MAC logo.PNG"
  },
  "University of Illinois-Chicago": {
    ...
    logoUrl: "/attached_assets/Chicago_State_Cougars_logo.svg.png"
  },
  "Michigan": {
    name: "Michigan",
    shortName: "Michigan",
